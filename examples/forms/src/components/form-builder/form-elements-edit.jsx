...
export default class FormElementsEdit extends React.Component {
  ...
  render() {
    ...
    const this_checked_center = this.props.element.hasOwnProperty('center')
      ...
      : false
    const this_checked_allow_filtering = this.props.element.hasOwnProperty(
      'allowFiltering'
    )
      ? this.props.element.allowFiltering
      : false
    const this_checked_profile_field = this.props.element.hasOwnProperty(
      'isProfileField'
    )
      ? this.props.element.isProfileField
      : false
    ...
    return (
      <div>
        ...
        {this.props.element.canHaveAnswer || this.props.element.canHaveOptionValue || this.props.element.canHaveOptionCorrect ? (
          <div className="form-group">
            <label className="control-label">Poster Options</label>
            <div className="checkbox">
              <label>
                <input
                  type="checkbox"
                  checked={this_checked_allow_filtering}
                  value={true}
                  onChange={this.editElementProp.bind(
                    this,
                    'allowFiltering',
                ...
                />
                Allow poster to filter by this field?
              </label>
            </div>
          </div>
        ) : (
          ...
          <div className="form-group">
            ...
            <div className="checkbox">
              <label>
                <input
                  type="checkbox"
                  checked={this_checked_profile_field}
                  value={true}
                  onChange={this.editElementProp.bind(
                    this,
                    'isProfileField',
                ...
                />
                Allow applicants to fill in this field in their profile?
              </label>
            </div>
          </div>
        ) : (
